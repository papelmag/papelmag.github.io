...
.contentheading a:visited{text-align:left; margin:0 0 0px 0; padding:20px 0 10px 0; font-size:18px; display:block; line-height:18px; font-family:"Trebuchet MS",sans-serif}
